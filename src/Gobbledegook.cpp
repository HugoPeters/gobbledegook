...
int ggkStart(const char *pServiceName, const char *pAdvertisingName, const char *pAdvertisingShortName, 
	GGKServerInitializer initalizer, GGKServerDataGetter getter, GGKServerDataSetter setter, int maxAsyncInitTimeoutMS)
{
	try
	{
		//
		...
		// Allocate our server
		TheServer = std::make_shared<Server>(pServiceName, pAdvertisingName, pAdvertisingShortName, initalizer, getter, setter);
